			...
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-0'>
				...
				<form className=" text-gray-500">
					<div>
						...
						<input type='text' placeholder='John Doe' className='w-full bg-zinc-900 input input-bordered  h-10' />
					</div>
					...
					<div>
						...
						<input type='text' placeholder='johndoe' className='w-full bg-zinc-900 input input-bordered h-10' />
					</div>
					...
					<div>
						...
						<input
							...
							className='w-full input input-bordered h-10 bg-zinc-900'
						/>
					</div>
